...
class _AdminQuizQuestionsScreenState extends State<AdminQuizQuestionsScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                _imageUploadButton(
                  ...
                  onRemove: () => setModalState(() => _questionImageUrl = null),
                ),
                const SizedBox(height: 16),
                            ...
                            GestureDetector(
                              onTap: () => setModalState(() {
                                if (_isMultipleAnswer) {
                                  if (_selectedCorrectAnswers.contains(key)) {
                                    // Don't allow deselecting all
                                    if (_selectedCorrectAnswers.length > 1) {
                                      _selectedCorrectAnswers.remove(key);
                                    }
                                  } else {
                                    _selectedCorrectAnswers.add(key);
                                  }
                                } else {
                                  _correctAnswer = key;
                                  _selectedCorrectAnswers = [key];
                                }
                              }),
                              child: Container(
                                width: 28,
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  shape: _isMultipleAnswer
                                      ? BoxShape.rectangle
                                      : BoxShape.circle,
                                  borderRadius: _isMultipleAnswer
  ...
  Future<void> _showNotifyDialog() async {
    ...
    final bodyController = TextEditingController(
      text:
          '"${_quiz.title}" is ready — ${_quiz.questions.length} questions waiting for you!',
    );
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  if (q.questionImageUrl != null)
                                    GestureDetector(
                                      onTap: () =>
                                          _showFullImage(q.questionImageUrl!),
                                      child: ClipRRect(
                                        borderRadius: BorderRadius.circular(8),
                                        child: Image.network(
                                          q.questionImageUrl!,
