        ...
        builder: (context, setModalState) => Padding(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(
                  comic == null ? 'Add New Book' : 'Edit Book',
                        ...
                        : const Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(color: AppTheme.booksColor),
                              ),
                            ],
                          ),
                  ),
                ...
                const SizedBox(height: 8),
                GestureDetector(
                  onTap: _isUploading ? null : () => _uploadPdf(setModalState),
                  child: Container(
                    ...
                    child: _isUploading && _uploadStatus.contains('PDF')
                        ? const Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(comic == null ? 'Add Book' : 'Update Book'),
                ),
              ],
            ),
          ),
